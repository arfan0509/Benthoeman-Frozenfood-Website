            ...
            <div class="container-konten">
                ...
                <form action="proses-edit.php" method="POST" enctype="multipart/form-data">
                    ...
                    <label for="nama">Nama Produk <br>
                        <input type="text" name="nama" id="nama" placeholder="Nama produk ...." value="<?php echo $d['nama_produk'] ?>">
                    </label>
                    <label for="harga">Harga <br>
                        <input type="number" name="harga" id="harga" placeholder="example: 20000" value="<?php echo $d['harga'] ?>">
                    </label>
                    <label for="detail">Detail <br>
                        <textarea name="detail" id="detail" cols="200" rows="13" placeholder="Detail produk ...."><?php echo $d['detail'] ?></textarea>
                    </label>
                    <input type="submit" name="tambah" value="SUBMIT" class="btn-submit">
                </form>
            </div>
        </section>
    </div>
